...
// UI »æÖÆº¯Êý
void drawUI(const std::vector<Gauge>& gauges, const std::map<std::string, Indicator>& indicators, const std::map<std::string, TriangleButton>& thrust_buttons, const Engine& engine, const AlertInfo& alertInfo);
